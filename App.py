...
# Apply theme to entire app using HTML
st.markdown(
    f"""
    <style>
        .main {{
...
# --- Title ---
st.markdown("<h1>Smart Resume Analyser</h1>", unsafe_allow_html=True)

# --- Sidebar ---
st.sidebar.markdown("## Choose User", unsafe_allow_html=True)
activities = ["Normal User", "Admin"]
choice = st.sidebar.selectbox("Choose among the given options:", activities)
st.sidebar.markdown("---")
st.sidebar.markdown("### 📘 About")
st.sidebar.info("This app helps analyze resumes and extract insights using AI.")
...
st.sidebar.markdown("[GitHub](https://github.com/spidy20)")
...
# Optional: Add some text or description below the image
st.markdown("### Welcome to the Smart Resume Analyzer tool!")
st.markdown("Analyze, parse and evaluate resumes with AI-based suggestions.")
...
'''
    ...
    if choice == 'Normal User':
        ...
        if st.button('Login'):
            if ad_user == 'Mukesh' and ad_password == 'mukesh123':
                st.success("Welcome Mukesh")
                # Display Data
